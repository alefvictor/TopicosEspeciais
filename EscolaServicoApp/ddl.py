...
""")
print("tabela disciplina foi criada.")
...
""")
print("tabela escola foi criada.")
...
""")
print("tabela endereco foi criada.")
...
""")
print("tabela campus foi criada.")
...
""")
print("tabela professor foi criada")
conn.close()
